<template>
  <div class="edit">
    <div class="contain">
      <div class="student">
        ...
        <div class="content">
          ...
          <div class="msg">
            ...
            <span v-show="errors.has('nickName')" class="is-danger">{{ errors.first('nickName') }}</span>
            <p>
              年级:
      ...
      <button @click="save()" :class="['save',errors.has('nickName')?'disabled-btn':'']">保存并修改</button>
    </div>
  </div>
</template>
<script>
